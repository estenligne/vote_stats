...
CREATE TABLE Locations (
	Id BIGINT PRIMARY KEY AUTO_INCREMENT,
	Type INT NOT NULL, -- Continent, Country, Region, City
	...
	INDEX IX_Locations_Type_ParentId (Type, ParentId),
...
CREATE TABLE Countries (
	...
	CallingCode VARCHAR(7) NULL,
	PhoneFormat VARCHAR(127) NULL,
	FlagImageURL VARCHAR(127) NULL,
	FOREIGN KEY (Id) REFERENCES Locations(Id) ON DELETE CASCADE
);
